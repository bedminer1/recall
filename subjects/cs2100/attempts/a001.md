...
Put each answer in its response block. The notes block is optional scratch work and
is never graded; the working-notes area above is for shortcuts and traps.
